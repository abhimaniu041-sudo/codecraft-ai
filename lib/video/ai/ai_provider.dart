...
class GroqProvider implements AIProvider {
  ...
  Future<String> generate(String prompt, {int maxTokens = 2000}) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw AIProviderException('Groq error: ${response.statusCode}');
    }
  }
}
...
class GeminiProvider implements AIProvider {
  ...
  Future<String> generate(String prompt, {int maxTokens = 2000}) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw AIProviderException('Gemini error: ${response.statusCode}');
    }
  }
}
...
class OpenRouterProvider implements AIProvider {
  ...
  Future<String> generate(String prompt, {int maxTokens = 2000}) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw RateLimitException('OpenRouter rate limit');
    } else {
      throw AIProviderException('OpenRouter error: ${response.statusCode}');
    }
  }
}
...
class HuggingFaceProvider implements AIProvider {
  ...
  Future<String> generate(String prompt, {int maxTokens = 2000}) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw AIProviderException('HuggingFace error: ${response.statusCode}');
    }
  }
}
